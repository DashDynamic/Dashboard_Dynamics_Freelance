  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="mt-4">
        ...
        <h2 className="text-xl font-bold mt-6 mb-2">Terms & Conditions</h2>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-bold mt-6 mb-2">You may:</h3>
        <p className="mb-1">a) Access any part of the website.</p>
        <p className="mb-4">b) Print a single copy of any or all pages for personal reference.</p>
        
        <h3 className="text-lg font-bold mt-6 mb-2">You may not:</h3>
        <ul className="list-disc ml-6 mb-4">
          <li className="mb-2">Copy (whether by printing, storing, downloading, or by any other means), distribute, broadcast, alter, or tamper with any material on the website, except as permitted under "You may."</li>
          <li className="mb-2">Remove any copyright, trademark, or other intellectual property notices from any material copied or printed from the website.</li>
          <li className="mb-2">Link to this website without express written consent.</li>
        </ul>
        ...
        <ul className="list-disc ml-6 mb-4">
          <li className="mb-2">The URL(s) of the web page(s) from which you propose to link to this website.</li>
          <li className="mb-2">The URL(s) of the web page(s) on this website to which you propose to link.</li>
        </ul>
        <p className="mb-4">
          We have the sole discretion to accept or reject such requests.
        </p>
        
        <h2 className="text-xl font-bold mt-6 mb-2">Changes in Terms & Conditions</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-bold mt-6 mb-2">Changes in Website Operations</h2>
        <p className="mb-4">
          Dash Dynamics may:
        </p>
        <ul className="list-disc ml-6 mb-4">
          <li className="mb-2">Modify the format and content of this website at any time.</li>
          <li className="mb-2">Suspend website operation for maintenance, updates, or other reasons.</li>
          <li className="mb-2">Terminate website access at any time without prior notice.</li>
        </ul>
        
        <h2 className="text-xl font-bold mt-6 mb-2">Data Protection</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-bold mt-6 mb-2">Complaints</h2>
        <p className="mb-4">
          If you have a question or complaint regarding this website, please contact the Dash Dynamics Administrator.
        </p>
        
        <h2 className="text-xl font-bold mt-6 mb-2">Jurisdiction</h2>
        <p className="mb-4">
